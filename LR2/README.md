...
![Диалоговое окно добавления](img/add.png=300x)
![Сообщение об успешном добавлении](img/add_result_message.png=300x)
![Результат добавления в таблице](img/add_result_table.png=300x)
...
![Добавление с пустым полем](img/add_empty_field.png=300x)
![Результат добавления с пустым полем](img/add_empty_field_result.png=300x)
...
4. Попытка добавить студента с некорректным форматом ФИО (менее 3 слов):
...
6. Попытка добавить студента с некорректным номером курса:
